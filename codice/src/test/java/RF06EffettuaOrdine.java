...
public class RF06EffettuaOrdine
{
    ...
    @Test
    public void testCalcolaPrezzo() throws RemoteException {
        var carrello = dbProdotti.query("SELECT * FROM Carrello");

        assertEquals(gestoreCarrelli.calcolaPrezzoTotale(carrello), 73.0, 2);
    }
