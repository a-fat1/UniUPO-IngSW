...
public interface GestoreRicercheInterfaccia extends Remote 
{
  ...
  //RF22
    public ArrayList<HashMap<String, Object>> ricercaProdotti(String titolo, String autore, String editori,
			String anno, ArrayList<String> lista) throws RemoteException;
	public boolean controlloValori(String titolo, String autore, String editori, String anno, ArrayList<String> lista) throws RemoteException;
