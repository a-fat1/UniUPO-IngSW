...
public class DbNotifiche implements DbNotificheInterfaccia
{
	public DbNotifiche()
	{
	}
	...
	public ArrayList<HashMap<String, Object>> query(String comandoSql)
	{
		...
		System.out.println("DbNotifiche: " + comandoSql + "\n");

		try 
		{
           		conn = DriverManager.getConnection("jdbc:sqlite:dati/DbNotifiche.db");		
